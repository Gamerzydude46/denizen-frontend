         ...
         <FormControl variant="standard" >
            <form className='mt-5 ml-14'>
                <ThemeProvider theme={CustomFontTheme}>
                    ...
                    <div  className='mt-16 display-flex justify-content gap-20 ml-20'>
                       
                            <div style={{ display:'flex',marginLeft:'50px',gap:'0%'}} >
                            <label>Business/Shop Registration Documents</label>
                            ...
                            <div style={{ display:'flex',marginLeft:'50px',marginTop:'12px',gap:'9%'}} >
                            <label>Registered Lease/Rent  Agreement</label>
                            ...
                            <div style={{ display:'flex',marginLeft:'50px',marginTop:'12px',gap:'18%'}} >
                            <label>Resident Ceritificate</label>
                         
                            <input type="file" id="id1" hidden="yes" />
                            <label for='id1' className='flex justify-center ml-20 documentButton text-oswald w-[120px] h-  '>
