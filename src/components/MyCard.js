...
function MyCard(props) {
  ...
  return (
    ...
    // <div className='w-[1400px] h-[228px]' >
    //   <img className="absolute top-4 left-6 w-[193px] h-[193px] rounded-lg shadow-md"
    // src={image}
    // alt={item_title}/>
    // <div className="z-10 relative flex items-start flex-shrink-0 w-[1400px] h-[228px] top-[25px] left-[65px] mb-8 rounded-lg border border-solid border-Primary_Red bg-White border-t-0 border-l-4 border-b-4">

    //   <div className='relative bg-Base w-[500px] h-[200px] top-4 left-[253px]'>
    // <div className="absolute">
    //   <h2 className="text-2xl font-medium font-maven text-black]">{item_title}</h2>
    // <div className="del-address">
    //   <img alt="loc" src={location} className="absolute top-[42px] left-[2px] w-5 h-5 mr-1" />
    ...
    // </div>
    // <div className="absolute  left-[350px] flex items-start">
    //   <div className="selling-cost">
    //     <img alt="prc" src={priceTag} className=" inline  w-7 h-7 mr-2" />
    //     <h3 className="inline   w-[200px] text-[19px] font-semibold font-maven text-Green ">
    //       Selling Cost:
    //     </h3>
    //     <p className=" top-[30px] left-[-100px]">Rs: {selling_cost}/-</p>
    //   </div>
    //   <div className="del-by absolute top-[160px] ">
    //     <img alt="trc"src={schedule} className="inline  w-6 h-6 mr-4"/>
    //     <h3 className="inline left-[-100px] w-[200px] text-[18px] font-semibold font-maven text-Grad_Blue">
    //       Delivery By:
    //     </h3>
    //     <p className=" mt-[-5px] ml-10 ">{deliver_date} </p>
    //     <p className="  mt-[-5px]  ml-10"> @{deliver_time}</p>
