...
function PostOrders() {
    ...
    const submitHandler = async(details) => {
        ...
        setLoading(true);
        const filePointer = getFiles('.file');
        const fileName = getFileName('.file');
        const imageURL = await uploadImage(filePointer);
        createItem(details.itemName, details.contact,details.sellingCost,details.date,details.time,details.category,details.distance,details.charges,details.address,details.latitude,details.longitude).then((response) => {
